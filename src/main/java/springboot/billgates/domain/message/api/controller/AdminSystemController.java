...
//    public ResponseEntity<Response<TemplateDto>> getTemplate(@PathVariable String type) {
//        return ResponseEntity.ok(Response.success("조회 성공", systemService.getTemplate(type)));
//    }
//
//    // 템플릿 수정
//    @PutMapping("/templates/{type}")
//    public ResponseEntity<Response<Void>> updateTemplate(@PathVariable String type, @RequestBody String content) {
