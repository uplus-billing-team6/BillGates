...
|                                         역할 및 담당 기능<br>작성해주세요                                         |                                       역할 및 담당 기능<br>작성해주세요                                        |                        Spring Batch Job/Step 구조 설계<br> 스케줄러 구현 기능<br>작성해주세요                        |                                 더미데이터 생성 로직 구현 <br> Spring Batch 정산 로직 구현                                 |                                         역할 및 담당 기능<br>작성해주세요                                         |
